...
(function() {
  ...
  Phaser.Utils.PhysicsItem2 = (function(_super) {
    __extends(PhysicsItem2, _super);

    PhysicsItem2.prototype.settings = {
      pixelsPerLengthUnit: 20,
      debugPolygons: true,
      lineWidth: 1
    };

    function PhysicsItem2(game, body, settings) {
      if (settings == null) {
        settings = {};
      }
      PhysicsItem2.__super__.constructor.call(this, game);
    ...
    PhysicsItem2.prototype.prepareDragable = function() {
      return;
    ...
    PhysicsItem2.prototype.update = function() {
      return this.updateSpriteTransform();
    };

    PhysicsItem2.prototype.updateSpriteTransform = function() {
    ...
    PhysicsItem2.prototype.draw = function() {
    ...
    PhysicsItem2.prototype.drawRectangle = function(g, x, y, angle, w, h, color, fillColor, lineWidth) {
      var _ref, _ref1;
    ...
    PhysicsItem2.prototype.drawCircle = function(g, x, y, angle, radius, color, lineWidth) {
    ...
    PhysicsItem2.prototype.drawLine = function(g, len, color, lineWidth) {
      lineWidth = (typeof lineWidth === "number" ? lineWidth : 1);
    ...
    PhysicsItem2.prototype.drawConvex = function(g, verts, triangles, color, fillColor, lineWidth, debug, offset) {
    ...
    PhysicsItem2.prototype.drawPath = function(g, path, color, fillColor, lineWidth) {
    ...
    PhysicsItem2.prototype.drawPlane = function(g, x0, x1, color, lineColor, lineWidth, diagMargin, diagSize, maxLength, angle) {
      var max, xd, yd;
      lineWidth = (typeof lineWidth === "number" ? lineWidth : 1);
    ...
    PhysicsItem2.prototype.randomPastelHex = function() {
    ...
    PhysicsItem2.prototype.rgbToHex = function(r, g, b) {
      return this.componentToHex(r) + this.componentToHex(g) + this.componentToHex(b);
    };

    PhysicsItem2.prototype.componentToHex = function(c) {
      var hex;
      hex = c.toString(16);
      if (hex.len === 2) {
        return hex;
